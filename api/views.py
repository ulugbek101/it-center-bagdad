...
def group_subject_delete(request):
    ...
    if request.GET.get('confirm'):
        ...
        if model_name == 'group':
            ...
            serialized_item['confirmationText'] = f"{serialized_item.get('name')} guruhini o'chirishga ishinchingiz komilmi ? " \
            ...
            serialized_item['confirmationText'] = f"{serialized_item.get('name')} fanini o'chirishga ishinchingiz komilmi ? " \
